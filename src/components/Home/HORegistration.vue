    ...
    <v-form ref="form">
      <v-row>
        ...
        >
          ...
          <v-col lg="1" xl="1" md="2" sm="2" align="center">
          ...
          <v-col lg="1" xl="1" md="2" sm="2" class="padding-left">
...
export default {
  ...
  methods: {
    search() {
      ...
      this.items = [];
      dataService
        .getRegistrationLinks(this.searchFor, this.searchBy, this.linkType)
        .then(response => {
          this.waiting = false;
  ...
  computed: {
    ...
    headers() {
      return [
        ...
        { text: "Registered", value: "isRegistered"},        
        { text: "Actions", value: "action", sortable: false , width: "200px" }
      ];
    }
  }
};
